...
def technical(symbol, key = get_api_key('alpha'), interval = "5min", output_size = "full"):
...
def get_stock_open_prices(ticker: str, dates: list, api_key=get_api_key('polygon_1') ) -> list:
    """
